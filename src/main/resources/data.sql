...
insert into atributo (elemento_id, atributo_tipo_id, codigo, nome, descricao, ordem) values ((select id from elemento where codigo = 'TESTE'), (select id from atributo_tipo where codigo = 'INTEGER'), 'CODIGO', 'Código', 'Código do Campo da Tabela', 1);
insert into atributo (elemento_id, atributo_tipo_id, codigo, nome, descricao, ordem) values ((select id from elemento where codigo = 'TESTE'), (select id from atributo_tipo where codigo = 'STRING'), 'VALOR', 'Valor', 'Valor do Campo da Tabela', 2);
